...
void Pointers_Char(void) {
	/**************************************************************************
	 * Display address of pointers using two different methods
	 *************************************************************************/
	char  initial  = 'P';
	char* pInitial = &initial;
	std::cout << "\n> Memory address for initial P: " << (void *)pInitial << std::endl;
	...
	std::cout << "\n> Think of a yes/no question, then ask the oracle" << std::endl;
	std::cout << "> Enter a number between 1 and 8: 4 (Hard Coded)";
//	std::cin >> choice;
